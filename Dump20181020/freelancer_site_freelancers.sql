...
CREATE TABLE `freelancers` (
  ...
  `spec_table` varchar(30) NOT NULL,
  `experience` tinyint(4) NOT NULL,
  `became_freelancer` timestamp NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `freelancers` VALUES (1,'DOCTOR',5,'2018-10-14 16:33:32'),(3,'GROOMER',8,'2018-10-17 10:34:48');
